...
data.Track.offset_x = 0;
data.Track.offset_y = 0; % need to fech from GUI, after adding those edit boxes
...
temp_idx = find(data.Track.Corrected.(data.body_parts{data.part2plot(data.correction_ind_in_part2plot)}).y(data.idx_current_trial_frs)> temp_bound_y(2) ...
...
temp_idx = find(data.Track.Corrected.(data.body_parts{data.part2plot(data.correction_ind_in_part2plot)}).y > temp_bound_y(2) ...
